...
export class Country extends $Base<"Country"> {
  ...
  ): $Field<"continent", GetOutput<Sel>, GetVariables<Sel>> {
    const options = {
  ...
  ): $Field<"languages", Array<GetOutput<Sel>>, GetVariables<Sel>> {
    const options = {
  ...
  ): $Field<"states", Array<GetOutput<Sel>>, GetVariables<Sel>> {
    const options = {
...
export class Query extends $Base<"Query"> {
  ...
  _entities<
    Args extends VariabledInput<{
      representations: Readonly<Array<CustomScalar<_Any>>>;
    }>,
  ...
  ): $Field<"_service", GetOutput<Sel>, GetVariables<Sel>> {
    const options = {
  ...
  >(
    ...
    selectorFn: (s: Continent) => [...Sel],
  ): $Field<"continent", GetOutput<Sel> | null, GetVariables<Sel, Args>> {
    const options = {
      argTypes: {
        code: "ID!",
      },
  ...
  continents<Sel extends Selection<Continent>>(
    selectorFn: (s: Continent) => [...Sel],
  ): $Field<"continents", Array<GetOutput<Sel>>, GetVariables<Sel>>;
  ...
  >(
    ...
    selectorFn: (s: Country) => [...Sel],
  ): $Field<"country", GetOutput<Sel> | null, GetVariables<Sel, Args>> {
    const options = {
      argTypes: {
        code: "ID!",
      },
  ...
  >(
    ...
    selectorFn: (s: Language) => [...Sel],
  ): $Field<"language", GetOutput<Sel> | null, GetVariables<Sel, Args>> {
    const options = {
      argTypes: {
        code: "ID!",
      },
...
export class State extends $Base<"State"> {
  ...
  country<Sel extends Selection<Country>>(
    selectorFn: (s: Country) => [...Sel],
  ): $Field<"country", GetOutput<Sel>, GetVariables<Sel>> {
    const options = {
      selection: selectorFn(new Country()),
    };
    return this.$_select("country", options as any) as any;
